...
const SocialButton = ({ social, children, onClick, disabled = false, className = '' }) => {
  const getSocialConfig = (social) => {
    ...
    return configs[social] || configs.google;
  };
  ...
  return (
    <button
      ...
      className={`
        ...
        focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:focus:ring-blue-400
